...
import com.push.blog.repositories.UserRepo;
...
public class PostServiceImpl implements PostService {
	...
	public PostResponse getAllPosts(int pageNumber, int pageSize, String sortBy, String sortDir) {
		...
		List<Post> allPages = pagePost.getContent();
		List<PostDto> postDtos = allPages.stream().map((post) -> this.modelMapper.map(post, PostDto.class))
